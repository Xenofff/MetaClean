...
const config = toolLandings.find((t) => t.slug === "what-is-my-photo-revealing")!;
...
const faqs = [
      {
        question: "What personal data can be found in my photos?",
        answer: "Your photos can reveal GPS coordinates of every location you have photographed, your camera or phone model, serial numbers, timestamps of when and where you took the picture, and sometimes your name.",
      },
      {
        question: "How can someone see this data?",
        answer: "Anyone with basic tools or even a right-click on some platforms can view the metadata in your photos, revealing your location, device, and personal information without your knowledge.",
      },
      {
        question: "Does every photo reveal private data?",
        answer: "Not every photo contains sensitive data, but most smartphone photos do by default. It is safer to assume your photos contain metadata and check before sharing publicly.",
      },
      {
        question: "What is the biggest privacy risk in photos?",
        answer: "GPS coordinates are the biggest privacy risk as they reveal exact locations including your home, workplace, and places you visit, potentially enabling stalking or burglary.",
      },
      {
        question: "How do I find out what my photo reveals?",
        answer: "Upload your photo to MetaClean to get a complete report of all data it reveals, including privacy risk assessment, specific data fields, and recommendations for cleaning the image.",
      }
];


export default function WhatIsMyPhotoRevealingPage() {
