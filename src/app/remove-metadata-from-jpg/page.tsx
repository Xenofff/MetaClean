...
const config = toolLandings.find((t) => t.slug === "remove-metadata-from-jpg")!;
...
const faqs = [
      {
        question: "What metadata is stored in JPG files?",
        answer: "JPG files can contain EXIF data such as camera model, lens, shutter speed, ISO, date taken, and GPS coordinates. This information is embedded automatically by your camera or phone and can reveal personal details about you.",
      },
      {
        question: "Will removing metadata affect JPG image quality?",
        answer: "No, removing metadata from JPG files does not change or degrade the image quality. Only the embedded information is stripped while the visual content remains identical.",
      },
      {
        question: "Is it safe to upload JPG files after metadata removal?",
        answer: "Yes, once metadata is removed the JPG file is safe to share on social media, marketplaces, or messaging apps without exposing your private information.",
      },
      {
        question: "Can I remove metadata from multiple JPG files at once?",
        answer: "Yes, MetaClean supports batch processing so you can strip metadata from multiple JPG images simultaneously, saving time when preparing large photo collections for sharing.",
      },
      {
        question: "Does removing JPG metadata strip location data?",
        answer: "Yes, the tool removes GPS coordinates and all other EXIF fields from your JPG files, ensuring no location information remains embedded in the image.",
      }
];


export default function RemoveMetadataFromJpgPage() {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          ...
          <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <li key="remove-metadata-from-jpeg">
                <Link
                  href="/remove-metadata-from-jpeg/"
                ...
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Remove Metadata From Jpeg</span>
                </Link>
              </li>
        ...
        <section className="mb-16">
          ...
          <ul className="grid gap-4 sm:grid-cols-2">
              <li key="remove-metadata-from-jpg-files">
                <Link
                  href="/learn/remove-metadata-from-jpg-files/"
                  className="flex items-center gap-3 rounded-xl border border-border bg-white p-5 hover:border-primary/30 hover:shadow-sm transition-all group"
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Remove Metadata From Jpg Files</span>
                </Link>
              </li>
