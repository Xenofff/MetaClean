...
const config = toolLandings.find((t) => t.slug === "remove-camera-information-from-photo")!;
...
const faqs = [
      {
        question: "What camera information is stored in photos?",
        answer: "Photos can contain camera make and model, lens type, focal length, aperture, shutter speed, ISO, white balance, and flash settings — all of which reveal your equipment details.",
      },
      {
        question: "Why would someone want to hide camera information?",
        answer: "Photographers may want to protect proprietary techniques, businesses may hide equipment investments, and casual users may simply prefer keeping their device details private.",
      },
      {
        question: "Does removing camera info affect image quality?",
        answer: "No, removing camera metadata has zero impact on image quality, resolution, or color. Only the informational tags are stripped while the visual content remains unchanged.",
      },
      {
        question: "Can camera information be used to identify me?",
        answer: "Yes, camera serial numbers and unique device information can potentially be linked to a specific individual, making camera metadata removal an important privacy step.",
      },
      {
        question: "Does this remove all camera-related metadata?",
        answer: "Yes, MetaClean strips all camera-related EXIF fields including make, model, lens, settings, and any device-specific information embedded in the image file.",
      }
];


export default function RemoveCameraInformationFromPhotoPage() {
