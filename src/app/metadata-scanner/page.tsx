...
const config = toolLandings.find((t) => t.slug === "metadata-scanner")!;
...
const faqs = [
      {
        question: "What does a metadata scanner detect?",
        answer: "A metadata scanner identifies all embedded information including EXIF data, GPS coordinates, device info, author names, dates, hidden annotations, and any other metadata fields.",
      },
      {
        question: "How is scanning different from viewing metadata?",
        answer: "Scanning performs a thorough analysis including non-standard fields, corrupted data, and hidden entries, while viewing only shows standard metadata in a basic format.",
      },
      {
        question: "Should I scan files before uploading them?",
        answer: "Yes, scanning files before uploading to social media, cloud storage, or email is a critical privacy practice that helps you identify and address potential data leaks.",
      },
      {
        question: "Can scanning detect hidden watermarks?",
        answer: "Yes, MetaClean's scanner can detect embedded watermarks, steganographic data, and unusual metadata entries that might indicate hidden tracking or identification markers.",
      },
      {
        question: "Is the scanning process secure?",
        answer: "Yes, all scanning is performed locally in your browser. Your files are never transmitted to external servers, ensuring complete confidentiality during the scanning process.",
      }
];


export default function MetadataScannerPage() {
