...
const config = toolLandings.find((t) => t.slug === "metadata-analyzer")!;
...
const faqs = [
      {
        question: "How does metadata analysis work?",
        answer: "MetaClean reads every metadata field in your file, categorizes the data by type, and presents a comprehensive report showing what information is embedded and its privacy implications.",
      },
      {
        question: "What privacy risks can metadata analysis reveal?",
        answer: "Analysis can reveal GPS coordinates exposing your location, camera serial numbers linking to your identity, timestamps showing your schedule, and software details about your setup.",
      },
      {
        question: "Is metadata analysis different from metadata checking?",
        answer: "Yes, analysis provides deeper insights including risk scoring, data categorization, and privacy recommendations, while checking simply displays the raw metadata fields.",
      },
      {
        question: "Can I analyze multiple files at once?",
        answer: "Yes, MetaClean supports batch analysis, allowing you to inspect metadata across multiple files simultaneously to quickly assess privacy risks in your photo collection.",
      },
      {
        question: "Does analysis reveal hidden or corrupted metadata?",
        answer: "Yes, the analyzer can detect non-standard metadata fields, corrupted data blocks, and unusual metadata entries that basic viewers might miss or display incorrectly.",
      }
];
