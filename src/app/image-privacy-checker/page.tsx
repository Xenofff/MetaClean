...
const config = toolLandings.find((t) => t.slug === "image-privacy-checker")!;
...
const faqs = [
      {
        question: "What privacy risks exist in images?",
        answer: "Images can contain GPS coordinates, camera serial numbers, timestamps, software information, and sometimes personal identifiers that create privacy and security risks.",
      },
      {
        question: "How does image privacy checking work?",
        answer: "MetaClean analyzes all metadata fields in your image, identifies privacy-sensitive data, and provides a detailed report with risk levels and specific data points found.",
      },
      {
        question: "Is image privacy different from photo privacy?",
        answer: "Image privacy is a broader term that covers all image types including screenshots, graphics, and edited images, while photo privacy specifically refers to camera-captured images.",
      },
      {
        question: "Can screenshots contain metadata?",
        answer: "Screenshots may contain device information, timestamps, and application metadata, though they typically do not include GPS data. MetaClean checks all metadata regardless of image type.",
      },
      {
        question: "Should businesses check image privacy?",
        answer: "Yes, businesses should check all images before publishing to prevent leaking internal information, employee data, location details, or proprietary camera equipment information.",
      }
];


export default function ImagePrivacyCheckerPage() {
